...
#including only patients who experienced violence 
testSubjects = ['S6646','S6541','S6539','S6497','S6439','S6410','S6274','S6246','S6119',
                'S6028','S6009','S6005','S6000','S5942','S5908','S5906','S5892','S5859',
                'S5801','S5793','S5784','S5771','S5752','S5746','S5720','S5691','S5615',
                'S5586','S5577','S5574','S5566','S5557','S5534','S5428','S5396','S5377',
                'S5361','S5343','S5320','S5250']

#including only patients who did not experience violence 
test2Subjects = ['S6727', 'S6720','S6715','S6698','S6646','S6580','S6560','S6540',
                'S6482','S6456','S6435','S6402','S6396','S6367','S6342','S6324','S6321','S6282',
                'S6166','S6151','S6131','S6101','S6098','S6086','S6084','S6079','S6056','S6049',
                'S6047','S5970','S5953','S5945','S5923','S5843','S5820','S5771','S5770','S5731']
...
for sub in testSubjects:
    ...
    for i in range(1,15):
        if NewCondition[i-1] == 1 or NewCondition[i-1] == 4:
            #make list of images for each subject for each block, only add image if during a performance/free block
            testImageList.append('\\Cyberball\\PatientData\\' + sub + '\\beta_' + '%04d' %i + '.nii')
            #make predictor list, append 0 for exclusion in either performance or free game
...
#test 2 - victims of violence controls
#initialize lists
test2ImageList = []
test2PredictorList = []
New2Condition = []
...
#test classifier on victims of violence
...
#test classifier on victims of violence controls
